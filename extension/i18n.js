...
(function attachTabHarborI18n(globalScope) {
  ...
  const i18nMessages = {
    en: {
      ...
      toastSessionRestoredWithGroupWarning: 'Restored {count} tabs; {failed} Chrome group settings need attention',
    ...
    'zh-CN': {
      ...
      toastSessionRestoredWithGroupWarning: '已恢复 {count} 个标签页；{failed} 个 Chrome 分组的名称或颜色未能完整恢复',
