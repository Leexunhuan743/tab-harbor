...
(function attachTabHarborI18n(globalScope) {
  ...
  const i18nMessages = {
    en: {
      ...
      closeExtrasLabel: 'Close {count} extra Tab Harbor{suffix}',
      ...
      toastNoDuplicatesClosed: 'No duplicate tabs were closed',
      toastAllTabsClosed: 'All tabs closed. Fresh start.',
      toastTabsClosedWithRemaining: 'Closed {closedCount} tabs; {remainingCount} remain open',
      toastTabsCloseFailed: 'Could not close tabs',
      ...
      closeDuplicateNewTabsLabel: 'Auto-close duplicate Tab Harbors',
      autoFocusSearchLabel: 'Auto-focus search on new tab',
      ...
      suggestSectionTabs: 'Open tabs',
      suggestSectionShortcuts: 'Quick links',
      suggestSectionSessions: 'Saved sessions',
      suggestSectionHistory: 'History',
      suggestHintArrows: 'Use ↑↓ to move, Enter to open',
      ...
      toastSessionSaved: 'Saved {count} tabs; closed {closedCount} originals',
      toastSessionTabsAdded: 'Added {count} tabs to saved session; closed {closedCount} originals; skipped {skipped} duplicates',
      toastNoSessionTabsSelected: 'Select at least one tab',
      toastSessionRestored: 'Restored {count} tabs',
      toastSessionRestoredWithGroupWarning: 'Restored {count} tabs; {failed} Chrome groups need attention',
      toastSessionRestoredWithGroupCreateWarning: 'Restored {count} tabs; {failed} Chrome groups could not be recreated',
      toastSessionRestoredWithGroupMetadataWarning: 'Restored {count} tabs; {failed} Chrome groups kept their tabs but need name or color attention',
      toastSessionRestoredWithGroupOrderWarning: 'Restored {count} tabs; {failed} Chrome groups may need tab order attention',
    ...
    'zh-CN': {
      ...
      closeExtrasLabel: '关闭多余 {count} 个 Tab Harbor',
      ...
      toastNoDuplicatesClosed: '没有关闭任何重复标签页',
      toastAllTabsClosed: '已关闭全部标签页，重新开始吧。',
      toastTabsClosedWithRemaining: '已关闭 {closedCount} 个标签页；仍有 {remainingCount} 个标签页保持打开',
      toastTabsCloseFailed: '无法关闭标签页',
      ...
      closeDuplicateNewTabsLabel: '自动关闭重复 Tab Harbor',
      autoFocusSearchLabel: '新标签页自动聚焦搜索框',
      ...
      suggestSectionTabs: '打开的标签页',
      suggestSectionShortcuts: '快捷链接',
      suggestSectionSessions: '已保存会话',
      suggestSectionHistory: '浏览历史',
      suggestHintArrows: '↑↓ 选择，Enter 打开',
      ...
      toastSessionSaved: '已保存 {count} 个标签页；已关闭 {closedCount} 个原标签页',
      toastSessionTabsAdded: '已加入 {count} 个标签页到已保存会话；已关闭 {closedCount} 个原标签页；跳过 {skipped} 个重复项',
      toastNoSessionTabsSelected: '请至少选择一个标签页',
      toastSessionRestored: '已恢复 {count} 个标签页',
      toastSessionRestoredWithGroupWarning: '已恢复 {count} 个标签页；{failed} 个 Chrome 分组需要检查',
      toastSessionRestoredWithGroupCreateWarning: '已恢复 {count} 个标签页；{failed} 个 Chrome 分组未能重新创建',
      toastSessionRestoredWithGroupMetadataWarning: '已恢复 {count} 个标签页；{failed} 个 Chrome 分组已保留标签，但名称或颜色需要检查',
      toastSessionRestoredWithGroupOrderWarning: '已恢复 {count} 个标签页；{failed} 个 Chrome 分组的标签顺序需要检查',
